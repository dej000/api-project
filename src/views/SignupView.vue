...
<div class="form-group d-flex flex-column justify-content-center align-items-center gap-3 "><button @click="topFunction" type="submit" class="btn submit-btn  btn-light log " id="myBtn">Create account     <div class="spinner-border spinner-border-sm " v-show="loading" role="status">
